...
const Time = ( { 
    ...
    let { addFieldPoints, handleTogglingModal,
...
return(
    <>  
        ...
        }   
        {
          <input
             type="time" 
             value={ formFieldElement?.inputValue ? formFieldElement?.inputValue : startTime } 
             onChange={ e => handleChangedValue( e.target.value, setStartTime, formFieldElement, saveFormField( { ...formFieldElement, inputValue: e.target.value } ) ) }
             placeholder="Time"
         />
        }  
    </>
