...
const FullTextSearchComponent_clean = ({ 
    searchContent,
...
export default connect(mapState, { loadPagedFullTextSearchContent, loadFullTextSearchContent } )(FullTextSearchComponent_clean);