...
import MyCoursesPage from 'teach/src/services/course/pages/Courses/MyCoursesPage';
import ShowMeeting from 'teach/src/services/course/pages/Meeting/components/ShowMeeting';
import CourseListPage from 'teach/src/services/course/pages/Courses/CourseListPage';
import CourseDetailPage from 'teach/src/services/course/pages/Courses/CourseDetailPage';
import LessonPage from 'teach/src/services/course/pages/Lessons/LessonPage';
import LoginPage from 'teach/src/services/course/pages/LoginPage';
import LessonPlan from 'teach/src/services/course/pages/Lessons/LessonPlan';
import LessonPlanInviteUserVerification from 'teach/src/services/course/pages/Lessons/LessonPlan/components/LessonPlanInviteUserVerification';
import LessonPlanInviteUserVerifiedPage from 'teach/src/services/course/pages/Lessons/LessonPlan/components/LessonPlanInviteUserVerifiedPage';
import NotFoundPage from 'teach/src/services/course/pages/components/NotFoundPage';
import SalesPage from 'teach/src/services/course/pages/SalesPage';
import Cart from 'teach/src/services/course/pages/SalesPage/Cart';
import Users from 'teach/src/services/course/pages/Users';
import IndividualUsersCourseList from 'teach/src/services/course/pages/Courses/IndividualUsersCourseList';
import BioPage from 'teach/src/services/course/pages/BioPage';
...
import CourseRatingsPage from 'teach/src/services/course/pages/Ratings';
import StudyHall from 'teach/src/services/course/pages/StudyHall';
import ClassRoomPage from 'teach/src/services/course/pages/ClassRoomPage';
import OperatorSignUpPage from 'teach/src/services/course/pages/OperatorSignupPage';
import StudentDetailPage from 'teach/src/services/course/pages/Users/StudentDetailPage';
import SessionPage from 'teach/src/services/course/pages/SessionPage';
import GradesPage from 'teach/src/services/course/pages/GradesPage';
import AttendancePage from 'teach/src/services/course/pages/AttendancePage';
import SendNotificationsPage from 'teach/src/services/course/pages/SendNotificationsPage';
import OnlineQuestionPage from 'teach/src/services/course/pages/OnlineQuestionsPage';
import AccountVerificationForm from 'teach/src/services/course/pages/SignUp/AccountVerificationForm';
import PasswordReset from 'teach/src/services/course/pages/LoginPage/components/PasswordReset';
import CalendarPage from 'teach/src/services/course/pages/CalendarPage';
import CalendarEventsDetailPage from 'teach/src/services/course/pages/CalendarPage/components/CalendarEventsDetailPage';
import EventDetailPage  from 'teach/src/services/course/pages/CalendarPage/components/EventDetailPage';
import AddNewCalendar from 'teach/src/services/course/pages/CalendarPage/components/AddNewCalendar';
import TimeLines from 'teach/src/services/course/pages/CalendarPage/components/TimeLines';
import OnlineQuestionsSavedAnswersPage from 'teach/src/services/course/pages/OnlineQuestionsPage/components/OnlineQuestionsSavedAnswersPage';
import OnlineQuestionsSavedAnswersDetailPage from 'teach/src/services/course/pages/OnlineQuestionsPage/components/OnlineQuestionsSavedAnswersDetailPage';
import OnlineQuestionsCourseListPage from 'teach/src/services/course/pages/OnlineQuestionsPage/components/OnlineQuestionsCourseListPage';
import MoreLessonContentPage from 'teach/src/services/course/pages/Courses/CourseDetailPage/MoreLessonContentPage';
