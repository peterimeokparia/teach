...
const DateTime = ( { 
    ...
    const [ currentDateTime, setCurrentDateTime ] = useState( getDateTime( fieldAnswer?.answer ) );
...
return(
    <>  
        ...
        {  <>
                <input
                    type="date" 
                    value={ currentDateTime?.date ? currentDateTime?.date : startDate} 
                    onChange={ e => setStartDate( e.target.value ) }
                    placeholder="Date"
                />
                <input
                    type="time" 
                    value={ currentDateTime?.time ? currentDateTime?.time : startTime} 
