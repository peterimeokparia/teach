...
return(
    <>  
        ...
        <input
            type="date" 
            value={ startDate }
            onChange={ e => handleChangedValue( e.target.value, setStartDate, formFieldElement, handleFormFieldAnswers( formFieldElement, e.target.value ) ) }
            placeholder="Date"
        />
        } 
    </>
...
export default connect( mapState, mapDispatch )(DateComponent);