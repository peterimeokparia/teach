...
export const columnsQuizz = [
    ...
    { id: 'takingDateTime', label: 'Taking Date', minWidth: 100, minHeight: 10,  align: 'left', align: 'right',  format: (value) => value.toLocaleString('en-US'), position: "absolute", zIndex: 100, x:100, y:-4  },
