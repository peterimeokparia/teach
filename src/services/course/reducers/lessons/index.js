...
LESSONPLAN_URL,
LESSONPLAN_COURSE,
HANDLE_CURRENT_LESSON_MEETING,
HANDLE_CURRENT_LESSON_ITEMS } from 'services/course/actions/lessons';
...
const reducer = produce((draft, action) => {
    switch(action.type){
     ...
     case HANDLE_CURRENT_LESSON_MEETING:
          draft.meetingProps = action.payload;
     return;
     case HANDLE_CURRENT_LESSON_ITEMS:
          draft.lessonProps = action.payload;
     return;
