...
const HeaderInfo = ({
    ...
    const [ signParentsName, setSignParentsName ] = useState('');
    const [ parentsSignatureDate, setParentsSignatureDate ] = useState(new Date());
        ...
        <form onSubmit={handleSubmit}> 
            <label>
                ...
                <input
                    type="date"
                    disabled={saveInProgress} 
                    value={parentsSignatureDate} 
                    onChange={(e) => setParentsSignatureDate(e.target.value)}
                />        
                </label>
                <label>
                <input
                    type="text"
                    disabled={saveInProgress} 
                    value={signParentsName} 
                    onChange={(e) => setSignParentsName(e.target.value)}
                />        
                </label>
            {
                <div>
