...
import { addNewFormFieldAnswer, saveFormFieldAnswer } from 'services/course/actions/formfieldanswers';
...
import { formFileViewer } from '../../helpers/FileViewer';
import FormFileViewerPanel from 'services/course/pages/FormBuilder/FormBuilderStepWizard/SelectExistingFormBuilderComponent/FormFields/component/FormFileViewerPanel';
...
const FileUploadField = ( { 
    ...
    // let { question, formUuId, eventId } = fieldProps;    
    let studentsAnswerExist = studentsAnswer && studentsAnswer?.answer && ( studentsAnswer?.answer !== null || studentsAnswer?.answer !== "" ); 
    ...
    }, [ studentsAnswerExist, studentsAnswer  ]);
    let {
        fileUploadUrl, 
