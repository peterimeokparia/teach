...
import { loadMeetings, loadMeetingsByMeetingId, saveMeeting } from 'services/course/actions/meetings';
...
import { getUsersByOperatorId, getCoursesByOperatorId } from 'services/course/selectors';
...
const VerifyMeetingAttendees = ({ 
  ...
  meetingId })  =>  {
  let meetingProps = { operatorBusinessName, currentUser, meetingId, selectedUserId, loadMeetingsByMeetingId };
