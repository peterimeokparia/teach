import { SAVE_NOTE_SUCCESS } from 'services/course/actions/notes';
import { ADD_COURSE_SUCCESS, SAVE_COURSE_SUCCESS } from 'services/course/actions/courses';
import { ADD_NEW_LESSON_SUCCESS, SAVE_LESSON_SUCCESS } from 'services/course/actions/lessons';
import { ADD_FORMFIELDS_SUCCESS, SAVE_FORMFIELDS_SUCCESS } from 'services/course/actions/formfields';
import { saveEditorMarkDown } from 'services/course/middleware/editor/saveEditorMarkDown';
import { buildSearchContent } from 'services/course/middleware/fullTextSearches/indexMarkDownContent';
