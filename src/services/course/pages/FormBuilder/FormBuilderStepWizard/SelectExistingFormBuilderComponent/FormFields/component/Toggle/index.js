        ...
        { 
         <div className=""> 
            <ToggleButton
                ...
                isChecked={ (  studentsAnswer && formBuilderState === elementMeta?.state.Taking  ) ? studentsAnswer['selected']  : ( formBuilderState === elementMeta?.state.Manage && toggleCheckBox?.id === formFieldElement?._id ) && toggleCheckBox?.isChecked }
